...
export const STATIC_I18N_KEYS = [
  ...
  'Older',
  'Session actions',
  'What would you like SunAPI to help with today?',
  'Pick a suggestion or type your question below.',
  'Scroll down to start typing',
  '{{count}} msgs',
  'Analyze data',
  'Analyze recent usage logs and find unusual trends',
  'Surprise me',
  'Give me an interesting prompt',
  'Summarize text',
  'Summarize this month channel usage',
  'Get advice',
  'Which model should I use to translate documents?',
  'Brainstorm',
  'Help me write a React Hook',
  'Help me come up with 5 product names',
  'Give me more prompt suggestions',
  'Choose resolution from the prompt',
  'Fast, good for previews',
  'Sharper, good for regular images',
  'High detail, model support required',
  'Choose aspect ratio from the prompt',
  'Square / avatar / product image',
  'Landscape / cover / desktop wallpaper',
  'Portrait / phone wallpaper / short video',
  'Classic banner / presentation image',
  'Portrait frame / people',
  ...
  'Please set an admin password with at least 8 characters',
  'Please enter the current password and set a new password with at least 8 characters',
  'Admin is already initialized. Please sign in directly',
  ...
  'Chat Area',
  'Chat functions',
  'Live conversations and chat presets.',
