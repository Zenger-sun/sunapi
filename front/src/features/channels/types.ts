...
export interface CodexOAuthCredentialData {
  key?: string
  account_id?: string
  email?: string
  expires_at?: string
...
export interface CodexOAuthCredentialResponse {
  success: boolean
  message?: string
  data?: CodexOAuthCredentialData
}

export type CodexOAuthCompleteResponse = CodexOAuthCredentialResponse
export type CodexRefreshTokenImportResponse = CodexOAuthCredentialResponse

export interface CodexCredentialRefreshResponse {
  success: boolean
  message?: string
  data?: CodexOAuthCredentialData & {
    channel_id?: number
