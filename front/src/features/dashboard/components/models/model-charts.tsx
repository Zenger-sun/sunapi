...
import { PieChart as PieChartIcon, WalletCards } from 'lucide-react'
...
type ModelChartsTab = 'quota' | ModelAnalyticsChartTab
...
export function ModelCharts(props: ModelChartsProps) {
  ...
  const [activeTab, setActiveTab] = useState<ModelChartsTab>('quota')
  ...
  const spec =
    activeTab === 'quota'
      ? chartData.spec_line
      : chartData[CHART_SPEC_KEYS[activeTab]]
