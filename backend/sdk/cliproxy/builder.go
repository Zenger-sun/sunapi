...
type Builder struct {
	...
	// pluginsDisabled skips dynamic plugin runtime wiring for lean local deployments.
...
func (b *Builder) WithPluginHost(host *pluginhost.Host) *Builder {
	b.pluginHost = host
	b.pluginsDisabled = false
	return b
}

// WithoutPlugins disables dynamic plugin runtime wiring for lean local deployments.
func (b *Builder) WithoutPlugins() *Builder {
	b.pluginHost = nil
	b.pluginsDisabled = true
	return b
}
...
func (b *Builder) Build() (*Service, error) {
	...
	if apiKeyProvider == nil {
		apiKeyProvider = NewDefaultAPIKeyClientProvider()
	}
	...
	if pluginHost == nil && !b.pluginsDisabled {
