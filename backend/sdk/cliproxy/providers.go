...
// NewDefaultAPIKeyClientProvider returns the default API key client loader that reuses existing logic.
func NewDefaultAPIKeyClientProvider() APIKeyClientProvider {
